...
>$求两个向量的差\vec{a}=\vec{b}$
>$类比实数运算，即求\vec{a}+(-\vec{b})$
>$-\vec{b}是什么？$
>$-\vec{b}叫做\vec{b}的相反向量$
>$-\vec{b}和\vec{b}大小相等，方向相反$
>$-\vec{b}+\vec{b}=\vec{0}$
>>$和0的定义类似，\vec{0}的相反向量依然是\vec{0}$
...
>[!help] 减法的意义
>$两个向量\vec{a},\vec{b}起点相同，\vec{a}-\vec{b}是连接两个向量的终点，$
>$方向指向被减向量$
...
>[!success] 题目3
>$若|\vec{a}+\vec{b}|=|\vec{a}-\vec{b}|,你能得到什么样的结论？$
...
>[!question] 思考
>$若两个向量\vec{a},\vec{b}满足|\vec{a}|=|\vec{b}|,且|\vec{a}+\vec{b}|=|\vec{a}-\vec{b}|能说明什么？$
